...
export class RetreatComponent implements OnInit {
	starsLoopUrl: string = 'assets/videos/Simple Stars - HD Video Background Loop (1).mp4';
	...
	faqContent = [
		...
		},
		{
			...
			answer: `A reputable charter bus company (<a href="https://shofur.com" target="_blank">Shofur</a>) will be taking students to and from the camp.`
		},
		{
